...
pfn_glBindFramebuffer qw_glBindFramebuffer = NULL;
pfn_glBindTexture qw_glBindTexture = NULL;
pfn_glBindVertexArray qw_glBindVertexArray = NULL;
pfn_glBlendColor qw_glBlendColor = NULL;
pfn_glBlendEquation qw_glBlendEquation = NULL;
pfn_glBlendFunc qw_glBlendFunc = NULL;
pfn_glBlendFuncSeparate qw_glBlendFuncSeparate = NULL;
pfn_glBufferData qw_glBufferData = NULL;
pfn_glClear qw_glClear = NULL;
pfn_glClearColor qw_glClearColor = NULL;
pfn_glClearDepthf qw_glClearDepthf = NULL;
pfn_glCompileShader qw_glCompileShader = NULL;
pfn_glCreateProgram qw_glCreateProgram = NULL;
pfn_glCreateShader qw_glCreateShader = NULL;
pfn_glDeleteBuffers qw_glDeleteBuffers = NULL;
pfn_glDeleteFramebuffers qw_glDeleteFramebuffers = NULL;
pfn_glDeleteProgram qw_glDeleteProgram = NULL;
pfn_glDeleteShader qw_glDeleteShader = NULL;
...
pfn_glFramebufferTexture2D qw_glFramebufferTexture2D = NULL;
pfn_glGenBuffers qw_glGenBuffers = NULL;
...
pfn_glGetStringi qw_glGetStringi = NULL;
...
pfn_glTexImage3D qw_glTexImage3D = NULL;
pfn_glTexParameteri qw_glTexParameteri = NULL;
pfn_glUniform1i qw_glUniform1i = NULL;
pfn_glUniform2f qw_glUniform2f = NULL;
pfn_glUniform2fv qw_glUniform2fv = NULL;
pfn_glUniform3f qw_glUniform3f = NULL;
pfn_glUniform3fv qw_glUniform3fv = NULL;
pfn_glUniform4f qw_glUniform4f = NULL;
pfn_glUniform4fv qw_glUniform4fv = NULL;
pfn_glUniformMatrix4fv qw_glUniformMatrix4fv = NULL;
pfn_glUseProgram qw_glUseProgram = NULL;
pfn_glVertexAttribPointer qw_glVertexAttribPointer = NULL;
pfn_glViewport qw_glViewport = NULL;

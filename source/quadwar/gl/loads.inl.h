...
LOAD_(qw_glBindFramebuffer, "glBindFramebuffer");
LOAD_(qw_glBindTexture, "glBindTexture");
LOAD_(qw_glBindVertexArray, "glBindVertexArray");
LOAD_(qw_glBlendColor, "glBlendColor");
LOAD_(qw_glBlendEquation, "glBlendEquation");
LOAD_(qw_glBlendFunc, "glBlendFunc");
LOAD_(qw_glBlendFuncSeparate, "glBlendFuncSeparate");
...
LOAD_(qw_glDeleteFramebuffers, "glDeleteFramebuffers");
...
LOAD_(qw_glFramebufferTexture2D, "glFramebufferTexture2D");
...
LOAD_(qw_glGetStringi, "glGetStringi");
...
LOAD_(qw_glTexImage3D, "glTexImage3D");
LOAD_(qw_glTexParameteri, "glTexParameteri");
LOAD_(qw_glUniform1i, "glUniform1i");
LOAD_(qw_glUniform2f, "glUniform2f");
LOAD_(qw_glUniform2fv, "glUniform2fv");
LOAD_(qw_glUniform3f, "glUniform3f");
LOAD_(qw_glUniform3fv, "glUniform3fv");
LOAD_(qw_glUniform4f, "glUniform4f");
LOAD_(qw_glUniform4fv, "glUniform4fv");
